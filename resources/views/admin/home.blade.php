...
{{--                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="{{route('route_BackEnd_Test_Detail', ['id' => $item->id])}}" style="white-space:unset;text-align: justify;"><i class="fa fa-edit">{{$item->name}}</i></a></td>--}}
